...
/**
 * @Description  营销素材-课程 修改
 * @author 卢祖飞
 * @date   2018-12-19
 * @version  1.0
 */
@Service
public class UpdateMarketingCourseService extends AbstractService{
	...
	protected Result doWork(IClientData data) throws Exception {
		...
		if(marketingCourse.getId() == null)
			throw new ValidataException("id不能为空");

		marketingCourse.setUpdateTime(DateUtil.getDateStr(new Date(),DateUtil.DATE_TIME));
		
		marketingCourseDao.updateMarketingCourse(marketingCourse);
