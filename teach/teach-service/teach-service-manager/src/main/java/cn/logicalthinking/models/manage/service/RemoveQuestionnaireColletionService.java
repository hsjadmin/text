...
/**
 * @Description  问卷情况汇总表 删除
 * @author 卢祖飞
 * @date   2018-12-19
 * @version  1.0
 */
@Service
public class RemoveQuestionnaireColletionService extends AbstractService{
	...
	protected Result doWork(IClientData data) throws Exception {
		...
		questionnaireColletionDao.removeQuestionnaireColletion(map);
